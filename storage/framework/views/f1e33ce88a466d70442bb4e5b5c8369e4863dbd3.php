	 ...
	 <div class="container ">
        ...
        <div class="row my-5 py-5">
        	<div class="col-md-6 text-center">
        		<img class="w-75 "  src="<?php echo e(asset('assets/image/product/gallery06.jpg')); ?>">
        	</div>
        	<div class="col-md-6 mt-5 mt-lg-0">
        		<h3 class="text-uppercase f-bold text-blue fix-font text-center text-lg-left"><span class="img-line"><img class="" src="<?php echo e(asset('assets/image/line.png')); ?>"></span>Contact Form</h3>
                <br><br><br><br>
                <form>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\flyncorp\resources\views/web/contact.blade.php ENDPATH**/ ?>