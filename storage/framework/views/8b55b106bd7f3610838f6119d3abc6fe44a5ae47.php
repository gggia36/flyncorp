    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" >
        <div class="carousel-inner">
            <div class="carousel-item active position-relative">
                <img src="<?php echo e(asset('assets/image/product/banner_main.jpg')); ?>" class="d-block w-100" alt="banner flyncorp" />
    ...
    <div class="container aos-init aos-animate"  data-aos="zoom-out-up" data-aos-duration="1000">
        <div class="row align-items-center">
            <div class="col-md-5 my-3 my-lg-0 order-lg-1 order-2">
                <img class="w-100" src="<?php echo e(asset('assets/image/product/aboutus_image.png')); ?>">
            </div>
...
<section class="py-1 my-1 py-lg-5 my-lg-5">
    <div class="container">
        ...
        <div class="row my-5">
            <div class="col-md-12 ">
                <img class="w-75 mx-auto" src="<?php echo e(asset('assets/image/logo/testimonial_logo.png')); ?>">
            </div>
        </div>
    </div>
</section>
...
<section class="bg-gradient">
    <div class="container py-5 aos-init aos-animate" data-aos="zoom-out-up" data-aos-duration="1000">
        <div class="row py-5">
            ...
            <div class="col-md-4">
                <img class="w-100" src="<?php echo e(asset('assets/image/product/gallery01.jpg')); ?>">
            </div>
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6 mt-lg-0 mt-4">
                        <img class="w-100"  src="<?php echo e(asset('assets/image/product/gallery02.jpg')); ?>">
                    </div>
                    <div class="col-md-6 mt-lg-0 mt-4">
                        <img class="w-100"  src="<?php echo e(asset('assets/image/product/gallery03.jpg')); ?>">
                    </div>
                    <div class="col-md-6 mt-4">
                        <img class="w-100"  src="<?php echo e(asset('assets/image/product/gallery04.jpg')); ?>">
                    </div>
                    <div class="col-md-6 mt-4">
                        <img class="w-100"  src="<?php echo e(asset('assets/image/product/gallery05.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\flyncorp\resources\views/web/index.blade.php ENDPATH**/ ?>