        ...
        <div class="col-md-12">
            <div class="card overflow-hidden">
                <div class="card-body border-bottom">
                    <h4 class="card-title mb-0"><?php echo e($MainMenus); ?></h4>
...
<div id="ModalAdd" class="modal fade"  aria-labelledby="primary-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <input type="hidden" id="default_image_src" value="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                        ...
                        <div class="row mb-3" id="upload_img">
                            <?php for($i = 1; $i < 7; $i++): ?>
                                ...
                                <div class="col-sm-4 main_web_logo mt-3"   style="max-width:100%; height: 220px; ">
                                    <div  id="add_delete_img_<?php echo e($i); ?>"  class="d-none " style="text-align:right;" >
                                    </div>
                                    <div class="col-sm-12 main_web_logo mt-3"  onclick="clickUpload(this,'#uploadFile<?php echo e($i); ?>')"  style="max-width:100%; height: 220px; ">
                                        <div class=" text-center div_preview_product" id="div_preview_img_product_<?php echo e($i); ?>" img-preview="<?php echo e($i); ?>" >
                                            <img class="img-thumbnail" id="add_preview_img_product_<?php echo e($i); ?>" style="max-width:100%; max-height: 220px;" src="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                                            <div class="text-inbox-center" id="image_placeholder_<?php echo e($i); ?>">
                                                <i class="fas fa-plus-circle set-icon "> <?php echo e($i); ?></i>
                                                
                                            </div>
                                        </div>
                                    </div>
                                    <input type="file" class="form-control upload-product-img d-none" type="file" id="uploadFile<?php echo e($i); ?>" name="image<?php echo e($i); ?>"  data-index="<?php echo e($i); ?>" accept="image/*">
                                </div>
                            <?php endfor; ?>
                        </div>
                ...
                <div class="modal-body">
                    <div class="form-horizontal form-upload">
                        ...
                        <div class="row mb-3" id="edit-upload_img">
                            <?php for($i = 1; $i < 7; $i++): ?>
                                <div class="col-sm-4 edit_main_web_logo mb-2 mt-2" onclick="clickUpload(this,'#edit-uploadFile<?php echo e($i); ?>')"  style="max-width:100%; height: 220px;">
                                    <div class=" mb-2 text-center edit_div_preview_product" id="edit-div_preview_img_product_<?php echo e($i); ?>" img-preview="<?php echo e($i); ?>" >
                                        <div class="" id="edit_product_image_<?php echo e($i); ?>">
                                            <img class="img-thumbnail" id="edit_preview_img_product_<?php echo e($i); ?>" style="max-width:100%; max-height: 220px;" src="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                                        </div>
                                        <div class="text-inbox-center" id="edit-image_placeholder_<?php echo e($i); ?>">
                                            <i class="fas fa-plus-circle set-icon "> <?php echo e($i); ?></i>
                                            
                                        </div>
                                    </div>
                                </div>
                                <input type="file" class="form-control edit-upload-product-img d-none" type="file" id="edit-uploadFile<?php echo e($i); ?>" name="image<?php echo e($i); ?>"  data-index="<?php echo e($i); ?>" accept="image/*">
                            <?php endfor; ?>
                        </div>
                        ...
                        <div class="row mb-3" id="view-upload_img">
                            <?php for($i = 1; $i < 7; $i++): ?>
                                <div class="col-sm-4 view_main_web_logo mb-2 mt-2"  style="max-width:100%; height: 220px;">
                                    <div class=" mb-2 text-center view_div_preview_product" id="view-div_preview_img_product_<?php echo e($i); ?>" img-preview="<?php echo e($i); ?>" >
                                        <div class="" id="view_product_image_<?php echo e($i); ?>">
                                            <img class="img-thumbnail" id="view_preview_img_product_<?php echo e($i); ?>" style="max-width:100%; max-height: 220px;" src="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                                        </div>
...
<?php echo $__env->make('layouts.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\flyncorp\resources\views/admin/Product/product.blade.php ENDPATH**/ ?>