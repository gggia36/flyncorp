...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('assets/ample/dist/css/style.min.css')); ?>" rel='stylesheet' media='screen'>
...
<body>
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo e(asset('assets/ample/src/images/background/login-register.jpg')); ?>) no-repeat center center; background-size: cover;">
...
<?php /**PATH C:\xampp\htdocs\flyncorp\resources\views/admin/login.blade.php ENDPATH**/ ?>