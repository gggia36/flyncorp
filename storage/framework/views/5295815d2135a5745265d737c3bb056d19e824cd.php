...
<?php $__env->stopSection(); ?> <?php $__env->startSection('modal'); ?>
                    ...
                    <div class="form-horizontal form-upload">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 main_web_logo">
                                ...
                                <div class="mt-3 mb-2">
                                <img class="img-thumbnail" id="add_preview_img" style="max-width:85%; max-height: 320px;"  src="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 edit_web_logo">
                                ...
                                <div class="mt-3 mb-2 " id="edit_preview_img">
                                    <img class="img-thumbnail"  style="max-width:85%; max-height: 320px;"  src="<?php echo e(asset('assets/uploads/images/no-image.jpg')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('assets/js/admin/category.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\flyncorp\resources\views/admin/Category/category.blade.php ENDPATH**/ ?>